...
cob.custom.customize.push(function (core, utils, ui) {
    core.customizeAllInstances(function (instance, presenter) {
        ...
        document.documentElement.style.setProperty("--dev-inline-display", "");
        ...
        if ( (dev == true || dev == "true")
            && (   $(".custom-hide").size()
                ...
                || $(".custom-hide-children").size()
                || $(".custom-disable-expand").size()
               )
            ){
            ...
            if(!document.getElementById("checkHidden")) {
                ...
                node.addEventListener ("input", function() {
                    if(show = !show) {
                        ...
                        document.documentElement.style.setProperty("--dev-inline-display", "inline-block");
                    } else {
                        document.documentElement.style.setProperty("--dev-display", "");
                        document.documentElement.style.setProperty("--dev-inline-display", "");
                    }
